...
{
	float distr = mod(floor(u_EmShapeDistrBurstID * .25), 3.);
...
void main()
{
	...
	//Set the random seed to a 2D vector where the first value is unique for this Em, and the second value is unique for this Pticle
