...
void main()
{
	...
	{	//////////////////////////////////////////////////////////////
		...
		seed = vec2(u_EmShapeDistrBurstID + parPtInd, parPtInd);
		...
		seed = vec2(u_EmShapeDistrBurstID + childPtInd, childPtInd);
	...
	{	///////////////////////////////////////////////////////////////
		...
		PtTimeAlive = u_EmTimeAlive - PtStartTime;
		seed = vec2(u_EmShapeDistrBurstID + basePtInd, basePtInd);
