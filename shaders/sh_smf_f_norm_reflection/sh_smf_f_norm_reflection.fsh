...
void main()
{
    ...
    //Lighting
    float Reflection = reflectionFactor * SpecValue;
    ...
    if (reflectionFactor > 0.0)
    {
        ...
        gl_FragColor.rgb = mix(gl_FragColor.rgb, reflectCol.rgb, SpecValue * min(2.0 * reflectionFactor, 1.0) * (reflectCol.r+reflectCol.g+reflectCol.b) / 3.0);
