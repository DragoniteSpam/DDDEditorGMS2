...
input.root.tween_rotate_y.interactive = input.interactive;

if (animation && timeline_layer != noone && !ui_is_active(input)) {
    input.value = string(animation_get_tween_rotate_y(animation, timeline_layer, floor(timeline.playing_moment)));
}
