...
function ui_particle_type_sprite(argument0) {
    ...
    if (selection + 1) {
        ...
        var el_update_list = create_list(col1_x, yy, "Particle Sprites", "<no particle sprites>", ew, eh, 10, ui_particle_type_sprite_assign, false, dg, Game.graphics.particles);
