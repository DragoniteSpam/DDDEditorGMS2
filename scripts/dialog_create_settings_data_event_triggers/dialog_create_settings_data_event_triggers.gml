/// @param Dialog
function dialog_create_settings_data_event_triggers(argument0) {
	...
	var el_list = create_list(32, yy, "Event Triggers", "", ew, eh, 20, uivc_list_selection_event_triggers, false, dg, Stuff.all_event_triggers);
