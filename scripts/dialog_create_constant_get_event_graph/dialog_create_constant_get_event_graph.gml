/// @param Dialog
/// @param DataConstant
function dialog_create_constant_get_event_graph(argument0, argument1) {
    ...
    var el_list = create_list(16, yy, "Select an event", "<how do you even have no events?>", ew, eh, 18, null, false, dg, Game.events.events);
