...
var value_now = kf_current ? kf_current.zz : value_default;
var value_previous = kf_previous ? kf_previous.zz : value_default;
var value_next = kf_next ? kf_next.zz : (animation.loops ? value_default : value_previous);
