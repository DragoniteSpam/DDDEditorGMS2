...
var el_value = create_input(c2 + 16, yy, "Value:", ew, eh, uivc_event_condition_attain_variable_value, value, "float", validate_double, -(1 << 31), (1 << 31) - 1, 11, vx1, vy1, vx2, vy2, dg);
