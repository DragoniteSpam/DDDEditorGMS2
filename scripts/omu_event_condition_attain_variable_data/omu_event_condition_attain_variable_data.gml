...
var el_list = create_list(16, yy, "Variables", "<no variables>", ew, eh, 16, null, false, dg);
...
var el_comparison = create_radio_array(c2 + 16, yy, "Comparison", ew, eh, null, comparison, dg);
...
var el_value = create_input(c2 + 16, yy, "Value:", ew, eh, null, 0, index, "float", validate_double, ui_value_real, -(1 << 31), (1 << 31) - 1, 11, vx1, vy1, vx2, vy2, dg);
