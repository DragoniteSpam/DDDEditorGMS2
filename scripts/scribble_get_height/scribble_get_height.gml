/// Returns: The height of the text element's bounding box, ignoring rotation and scaling
/// @param string/textElement   The text to get the bounding box for. Alternatively, you can pass a text element into this script
/// @param [page]               Find the height of this specific page. Defaults to <undefined>, returning the maximal height of all pages
