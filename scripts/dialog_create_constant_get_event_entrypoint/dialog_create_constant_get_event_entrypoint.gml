/// @param Dialog
/// @param DataConstant
function dialog_create_constant_get_event_entrypoint(argument0, argument1) {
	...
	var el_confirm = create_button(dw / 2 - b_width / 2, dh - 32 - b_height / 2, "Select Entrypoint", b_width, b_height, fa_center, dmu_dialog_constant_set_event_node_only, dg);
