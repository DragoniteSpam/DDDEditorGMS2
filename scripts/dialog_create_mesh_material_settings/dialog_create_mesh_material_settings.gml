function dialog_create_mesh_material_settings(mesh_list, selection) {
    ...
    var tabs = new EmuTabGroup(default_mesh_tex_only ? col1 : col2, EMU_BASE, ew + 32 + 32, dg.height - 128, 1, eh);
    if (!IS_MESH_MODE) {
        tabs.AddTabs(0, [tab_base, tab_normal, tab_specular_color, tab_specular]);
    } else {
