...
var value_now = kf_current ? kf_current.yy : value_default;
var value_previous = kf_previous ? kf_previous.yy : value_default;
var value_next = kf_next ? kf_next.yy : (animation.loops ? value_default : value_previous);
