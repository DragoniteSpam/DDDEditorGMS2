function refid_remove(entity, map_container = Stuff.map.active_map) {
...
function refid_generate(map_container = Stuff.map.active_map) {
    var n;
    do {
...
function refid_get(refid, map_container = Stuff.map.active_map) {
    return map_container.contents.refids[$ refid];
}

function refid_set(data, refid, map_container = Stuff.map.active_map) {
