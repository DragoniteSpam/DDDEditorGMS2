...
function dialog_create_event_delete(argument0, argument1) {
    ...
    var dg = dialog_create(dw, dh, "Delete Event?", dialog_default, undefined, root);
    dg.event = event;
    ...
    var el_text = create_text(col1_x, yy, "Are you sure you want to delete " + event.name + "?", ew, eh, fa_left, ew, dg);
