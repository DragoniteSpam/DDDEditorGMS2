...
var value_now = kf_current ? kf_current.yrot : value_default;
var value_previous = kf_previous ? kf_previous.yrot : value_default;
var value_next = kf_next ? kf_next.yrot : (animation.loops ? value_default : value_previous);
