...
yy = yy + 32;
var el_encounter_base = create_input(c3, yy, "Base Encounter Rate", ew, eh, uivc_settings_map_encounter_base, 0, ActiveMap.base_encounter_rate, "0 for off", validate_int, ui_value_real, 0, 1000000, 7, vx1, vy1, vx2, vy2, dg);
yy = yy + 32;
