...
if (ds_map_exists(Stuff.all_refids, addition)) {
    ds_map_delete(Stuff.all_refids, addition);
}
...
if (ds_map_exists(Stuff.all_refids, addition)) {
    ...
    ds_map_delete(Stuff.all_refids, argument[0].REFID);
}

ds_map_add(Stuff.all_refids, addition, argument[0]);
