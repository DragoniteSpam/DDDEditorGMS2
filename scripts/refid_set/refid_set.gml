...
if (ds_map_exists(Stuff.active_map.contents.all_refids, addition)) {
    ds_map_delete(Stuff.active_map.contents.all_refids, addition);
}
...
if (ds_map_exists(Stuff.active_map.contents.all_refids, addition)) {
    ...
    ds_map_delete(Stuff.active_map.contents.all_refids, argument[0].REFID);
}

ds_map_add(Stuff.active_map.contents.all_refids, addition, argument[0]);
