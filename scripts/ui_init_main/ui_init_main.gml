    ...
    tab_group.AddTabs(2, [
        (new EmuTab("Mesh Settings")).AddContent([
            ...
            (new EmuButton(col2x, EMU_AUTO, element_width, element_height, "Advanced", function() {
                var index = self.GetSibling("MESH LIST").GetSelection();
                if(index == -1) return;
                show_message("the code to spawn this dialogue doesnt look right but i don't feel like fixing it right now - if you ever come back to this you might want to do that");
