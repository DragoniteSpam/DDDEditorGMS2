function dialog_create_settings_data_collision_triggers(dialog) {
    var dw = 320;
    var dh = 680;
    
    var dg = dialog_create(dw, dh, "Data Settings: Collision Triggers", dialog_default, dc_close_no_questions_asked, dialog);
    ...
    var el_list = create_list(32, yy, "Collision Triggers", "", ew, eh, 20, function(list) {
        var selection = ui_list_selection(list);
        ui_input_set_value(list.root.el_name, Stuff.all_collision_triggers[| selection]);
    }, false, dg, Stuff.all_collision_triggers);
