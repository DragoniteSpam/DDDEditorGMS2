...
var el_load = create_button(dw / 4 - b_width / 2, dh - 32 - b_height * 2, "Import", b_width, b_height, fa_center, dmu_dialog_mesh_autotile_import, dg);
var el_save = create_button(dw / 2 - b_width / 2, dh - 32 - b_height * 2, "Export", b_width, b_height, fa_center, dmu_dialog_mesh_autotile_export, dg);
var el_import_series = create_button(dw * 3 / 4 - b_width / 2, dh - 32 - b_height * 2, "Import Batch", b_width, b_height, fa_center, dmu_dialog_mesh_autotile_import_batch, dg);
