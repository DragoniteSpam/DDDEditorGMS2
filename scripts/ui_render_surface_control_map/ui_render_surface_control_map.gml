...
mouse_vector = update_mouse_vector(Camera.event_x, Camera.event_y, Camera.event_z, Camera.event_xto,
	Camera.event_yto, Camera.event_zto, Camera.event_xup, Camera.event_yup, Camera.event_zup, Camera.event_fov, CW / CH);

var xx = mouse_vector[vec3.xx] * MILLION;
var yy = mouse_vector[vec3.yy] * MILLION;
var zz = mouse_vector[vec3.zz] * MILLION;

if (c_raycast_world(Camera.event_x, Camera.event_y, Camera.event_z, Camera.event_x + xx, Camera.event_y + yy, Camera.event_z + zz, ~0)) {
