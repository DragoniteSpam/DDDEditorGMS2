...
// code only
var el_property_default_code = create_input_code(col3_x, yy, "Default Code:", ew, eh, vx1, vy1, vx2, vy2, "", uivc_input_data_default_code, dg);
el_property_max.enabled = true;
...
ds_list_add(dg.contents, el_list, el_add, el_add_enum, el_remove,
    ...
    el_property_max, el_property_scale, el_property_default_code,
    el_confirm);
