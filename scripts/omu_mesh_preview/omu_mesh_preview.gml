/// @param UIButton
function omu_mesh_preview(argument0) {
...
#region controls
	...
	var el_control_scale = create_input(col4_x, yy, "Scale:", ew, eh, uivc_mesh_preview_scale, Stuff.mesh_scale, "float", validate_double, 0.1, 100, 4, vx1, vy1, vx2, vy2, dg);
