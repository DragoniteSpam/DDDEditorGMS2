...
var el_input = create_input(col1_x, yy, "Name:", ew, eh, uivc_list_event_attain_event_name, event.name, "", validate_string, 0, 1, VISIBLE_NAME_LENGTH, vx1, vy1, vx2, vy2, dg);
yy += el_input.height;
