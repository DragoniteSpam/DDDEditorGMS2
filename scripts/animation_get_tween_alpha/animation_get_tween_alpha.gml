...
var value_now = (kf_current ? kf_current.alpha : value_default) + (rel_current ? rel_current.alpha : 0);
var value_previous = (kf_previous ? kf_previous.alpha : value_default) + (rel_previous ? rel_previous.alpha : 0);
var value_next = (kf_next ? kf_next.alpha : (animation.loops ? value_default : value_previous)) + (rel_next ? rel_next.alpha : 0);
