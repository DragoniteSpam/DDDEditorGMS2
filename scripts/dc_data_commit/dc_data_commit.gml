...
if (button.root.changed && ds_list_size(Stuff.original_data) > 0) {
    ...
    var el_text = create_text(dw / 2, dh * 2 / 5, "We have detected that you may have made some important changes to the game data. We have not detected if this may cause conflicts with anything else, but if there any, they will be resolved by being nuked. Okay?\n\n(If you've deleted data types or properties but aren't certain if you're going to want them back, it's probably best to just have them and not use them - you can have them exist in the data file but be discarded by the game)\n\n((You can cancel changes instead by clicking the X at the top of the window))", 0, 0, fa_center, dw - 96, dg);
