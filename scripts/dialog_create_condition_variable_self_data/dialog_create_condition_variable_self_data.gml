...
var el_value = create_input(c2 + 16, yy, "Value:", ew, eh, uivc_check_event_condition_value, 0, list_value[| index], "float", validate_double, ui_value_real, -(1 << 31), (1 << 31) - 1, 11, vx1, vy1, vx2, vy2, dg);
