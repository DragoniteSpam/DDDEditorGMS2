/// @param EventNode
/// @param index
function dialog_create_condition_variable_self_data(argument0, argument1) {
    ...
    var dg = dialog_create(dw, dh, "Condition: Self Variable", dialog_default, dialog_destroy, node);
    dg.node = node;
    dg.index = index;
