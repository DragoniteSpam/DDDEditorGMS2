/// @param Dialog
function dialog_create_entity_effect_com_lighting(argument0) {
	...
	var el_type = create_radio_array(col1_x, yy, "Type", ew, eh, uivc_entity_effect_com_lighting_type, (single ? (com_light ? com_light.light_type : 0) : -1), dg);
...
#region directional lights
	...
	var el_dir_x = create_input(col1_x, yy, "X:", ew, eh, uivc_entity_effect_com_lighting_dx, com_dir ? string(com_dir.light_dx) : "", "float", validate_double, -1, 1, 4, vx1, vy1, vx2, vy2, dg);
...
#region point lights
	...
	var el_point_radius = create_input(col1_x, yy, "Radius:", ew, eh, uivc_entity_effect_com_lighting_radius, com_point ? string(com_point.light_radius) : "", "float", validate_double, 0.1, 0xffffff, 10, vx1, vy1, vx2, vy2, dg);
