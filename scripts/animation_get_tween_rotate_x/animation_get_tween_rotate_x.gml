...
var value_now = kf_current ? kf_current.xrot : value_default;
var value_previous = kf_previous ? kf_previous.xrot : value_default;
var value_next = kf_next ? kf_next.xrot : (animation.loops ? value_default : value_previous);
