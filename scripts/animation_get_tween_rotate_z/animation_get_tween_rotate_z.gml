...
var value_now = kf_current ? kf_current.zrot : value_default;
var value_previous = kf_previous ? kf_previous.zrot : value_default;
var value_next = kf_next ? kf_next.zrot : (animation.loops ? value_default : value_previous);
