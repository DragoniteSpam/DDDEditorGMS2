...
var value_now = kf_current ? kf_current.zscale : value_default;
var value_previous = kf_previous ? kf_previous.zscale : value_default;
var value_next = kf_next ? kf_next.zscale : (animation.loops ? value_default : value_previous);
