...
var value_previous = kf_previous[0] ? kf_previous[0].xx : 0;
var value_next = kf_next[0] ? kf_next[0].xx : value_previous;
...
return tween(value_previous, value_next, f, kf_previous[0] ? kf_previous[0].tween_xx : AnimationTweens.NONE);