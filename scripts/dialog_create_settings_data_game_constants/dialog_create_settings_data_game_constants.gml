...
var el_type_ext = create_button(c2 + 32, yy, "Other Data Types", ew, eh, fa_middle, omu_global_data_select_type, dg);
...
var el_value_real = create_input(c3 + 32, yy, "Value:", ew, eh, uivc_input_constant_value_real, "0", "number", validate_double, -0x80000000, 0x7fffffff, 10, vx1, vy1, vx2, vy2, dg);
el_value_real.enabled = false;
dg.el_value_real = el_value_real;
var el_value_int = create_input(c3 + 32, yy, "Value:", ew, eh, uivc_input_constant_value_real, "0", "int", validate_int, -0x80000000, 0x7fffffff, 11, vx1, vy1, vx2, vy2, dg);
...
var el_value_data = create_list(c3 + 32, yy + ui_get_list_height(el_type_guid) + spacing, "Instance:", "<no data>", ew, eh, 8, uivc_input_constant_value_guid, false, dg, noone);
