...
var el_value_code = create_input_code(c2 + 32, yy, "Value:", ew, eh, vx1, vy1, vx2, vy2, "", uivc_input_constant_value, dg);
el_value_code.enabled = false;
dg.el_value_code = el_value_code;
var el_value_string = create_input(c2 + 32, yy, "Value:", ew, eh, uivc_input_constant_value, "", "", "text", validate_string, ui_value_string, 0, 1, 160, vx1, vy1, vx2, vy2, dg);
el_value_string.enabled = false;
dg.el_value_string = el_value_string;
var el_value_real = create_input(c2 + 32, yy, "Value:", ew, eh, uivc_input_constant_value, "", "0", "number", validate_double, ui_value_real, -1 << 31, 1 << 31 - 1, 10, vx1, vy1, vx2, vy2, dg);
el_value_real.enabled = false;
dg.el_value_real = el_value_real;
var el_value_int = create_input(c2 + 32, yy, "Value:", ew, eh, uivc_input_constant_value, "", "0", "int", validate_int, ui_value_real, -1 << 31, 1 << 31 - 1, 11, vx1, vy1, vx2, vy2, dg);
