...
/// @param multi-index
function dialog_create_event_node_img_etc(argument0, argument1, argument2, argument3) {

    var dw = 320;
    var dh = 640;

    var dg = dialog_create(dw, dh, "Misc. Graphics", dialog_default, dialog_destroy, argument0);
    ...
    var el_list = create_list(16, yy, "All Misc. Graphics", "<no misc graphics>", ew, eh, n_slots, null, false, dg, Game.graphics.etc);
