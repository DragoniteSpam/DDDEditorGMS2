...
graphics_set_lighting(shd_water_base);
transform_set(0, 0, map.water_level * TILE_DEPTH - 1, 0, 0, 0, 1, 1, 1);
...
graphics_set_lighting(shd_water_bright);
transform_set(0, 0, map.water_level * TILE_DEPTH, 0, 0, 0, 1, 1, 1);
texture_set_stage(shader_get_sampler_index(shd_water_bright, "displacementMap"), sprite_get_texture(spr_water_displacement, 0));
shader_set_uniform_f(shader_get_uniform(shd_water_bright, "displacement"), 0.0625);
