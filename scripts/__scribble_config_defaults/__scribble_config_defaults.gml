...
// !
#macro SCRIBBLE_DEFAULT_COLOR               Settings.colors.text  //Default vertex colour when drawing text models. This can be overwritten by the .starting_format() text element method
