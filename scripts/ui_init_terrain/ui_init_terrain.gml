        ...
        element = create_button(legal_x + spacing, yy, "Reset Height", col_width, element_height, fa_center, function(button) {
            ...
            for (var i = 0; i < terrain.width - 1; i++) {
                for (var j = 0; j < terrain.height - 1; j++) {
                    ...
                    var index1 = index0 + VERTEX_SIZE_TERRAIN;
                    var index2 = index1 + VERTEX_SIZE_TERRAIN;
                    var index3 = index2 + VERTEX_SIZE_TERRAIN;
                    var index4 = index3 + VERTEX_SIZE_TERRAIN;
                    var index5 = index4 + VERTEX_SIZE_TERRAIN;
