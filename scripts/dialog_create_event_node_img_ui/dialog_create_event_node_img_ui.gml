...
function dialog_create_event_node_img_ui(argument0, argument1, argument2, argument3) {
	...
	var dg = dialog_create(dw, dh, "UI", dialog_default, dc_close_no_questions_asked, argument0);
	...
	var el_list = create_list(16, yy, "All UI Graphics", "<no UI graphics>", ew, eh, n_slots, null, false, dg, Stuff.all_graphic_ui);
