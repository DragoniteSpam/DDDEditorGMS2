/// @param Dialog
function dialog_create_manager_graphic_skybox(argument0) {
    ...
    var dg = dialog_create(dw, dh, "Data: Availalbe Skybox Graphics", dialog_default, dc_default, dialog);
    ...
    var el_list = create_list(16, yy, "Skybox Graphics", "<no skybox graphics>", ew, eh, 12, uivc_list_graphic_generic, false, dg, Stuff.all_graphic_skybox);
    ...
    var el_add = create_button(16, yy, "Add Image", ew, eh, fa_center, dmu_dialog_load_graphic_skybox, dg);
    yy += el_add.height + spacing;

    var el_remove = create_button(16, yy, "Delete Image", ew, eh, fa_center, dmu_dialog_remove_graphic_skybox, dg);
