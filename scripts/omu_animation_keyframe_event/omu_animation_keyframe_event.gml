...
if (keyframe) {
    ...
    var el_graphic_sprite_list = create_list(col2_x + 16, yy, "Sprite", "<no sprites>", ew, eh, 16, stack_trace, false, dg);
    ...
    var el_graphic_mesh_list = create_list(col2_x + 16, yy, "Mesh", "<no meshes>", ew, eh, 16, stack_trace, false, dg);
