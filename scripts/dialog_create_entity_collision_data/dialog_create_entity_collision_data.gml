function dialog_create_entity_collision_data(root) {
    var dw = 1280;
    var dh = 640;
    ...
    var dg = dialog_create(dw, dh, "Flag Data: " + entity.name, dialog_default, dc_close_no_questions_asked, root);
    ...
    var el_collision_flags = create_bitfield(c1, yy, "Flags", ew, eh, entity.collision_flags, dg);
