...
var el_remove = create_button(c2 + 16, yy, "Remove Overworld", ew, eh, fa_center, dmu_dialog_remove_graphic_overworld, dg);
...
var el_name = create_input(c2 + 16, yy, "", ew, eh, uivc_input_graphic_overworld_name, "", "", "", validate_string, ui_value_string, 0, 1, VISIBLE_NAME_LENGTH, vx1, vy1, vx2, vy2, dg);
dg.el_name = el_name;
...
var el_name_internal = create_input(c2 + 16, yy, "", ew, eh, uivc_input_graphic_overworld_internal_name, "", "", "A-Za-z0-9_", validate_string_internal_name, ui_value_string, 0, 1, INTERNAL_NAME_LENGTH, vx1, vy1, vx2, vy2, dg);
