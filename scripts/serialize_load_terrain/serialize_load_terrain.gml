/// @param buffer
/// @param version
function serialize_load_terrain() {
    ...
    repeat (n_terrain) {
        ...
        Stuff.terrain.ui.t_general.element_height.text = "Height: " + string(terrain.height);
        terrain.width = buffer_read(buffer, buffer_u16);
        Stuff.terrain.ui.t_general.element_width.text = "Width: " + string(terrain.width);
    
        var bools = buffer_read(buffer, buffer_u32);
        terrain.export_all = unpack(bools, 1);
        Stuff.terrain.ui.t_general.element_save_all_faces.value = terrain.export_all;
        terrain.export_swap_uvs = unpack(bools, 3);
        Stuff.terrain.ui.t_general.element_swap_uvs.value = terrain.export_swap_uvs;
        terrain.export_swap_zup = unpack(bools, 4);
        Stuff.terrain.ui.t_general.element_swap_zup.value = terrain.export_swap_zup;
        ...
        Stuff.terrain.ui.t_general.element_save_scale.value = string(terrain.save_scale);
