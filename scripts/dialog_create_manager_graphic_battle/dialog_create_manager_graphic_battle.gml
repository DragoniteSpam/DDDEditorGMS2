...
var el_remove = create_button(16, yy, "Remove Battler", ew, eh, fa_center, dmu_dialog_remove_graphic_general, dg);
...
var el_export = create_button(c2 + 16, yy, "Export Battler", ew, eh, fa_center, dmu_dialog_export_graphic, dg);
