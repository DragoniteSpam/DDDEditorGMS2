...
event_prefab[EventNodeTypes.INPUT_TEXT] = new EventNodePeristent("InputText", [
...
event_prefab[EventNodeTypes.SHOW_SCROLLING_TEXT] = new EventNodePeristent("TextCrawl", [
    ["Text", DataTypes.STRING, 0, 250, false, "Text that is shown in the text crawl goes here"],
]);
event_prefab[EventNodeTypes.SHOW_CHOICES] = new EventNodePeristent("ShowChoices", [
...
event_prefab[EventNodeTypes.CONTROL_SWITCHES] = new EventNodePeristent("ControlGlobalSwitch", [
...
event_prefab[EventNodeTypes.CONTROL_VARIABLES] = new EventNodePeristent("ControlGlobalVariable", [
...
event_prefab[EventNodeTypes.CONTROL_SELF_SWITCHES] = new EventNodePeristent("ControlSelfSwitch", [
...
event_prefab[EventNodeTypes.CONTROL_SELF_VARIABLES] = new EventNodePeristent("ControlSelfVariable", [
    ["Entity", DataTypes.ENTITY],
...
event_prefab[EventNodeTypes.CONTROL_TIME] = new EventNodePeristent("ControlTimer", [
...
event_prefab[EventNodeTypes.CONDITIONAL] = new EventNodePeristent("Conditional", [
    // conditional branch nodes are not actually handled as a prefab but i'm leaving this here for reference
    ["Type", DataTypes.INT],
    ["Index", DataTypes.INT],
...
event_prefab[EventNodeTypes.INVOKE_EVENT] = new EventNodePeristent("WillNotBeImplemented", []);
event_prefab[EventNodeTypes.COMMENT] = new EventNodePeristent("ImplementedElsewhere", []);
event_prefab[EventNodeTypes.WAIT] = new EventNodePeristent("Wait", [["Seconds", DataTypes.FLOAT, 0, 1, false, 1]]);
event_prefab[EventNodeTypes.TRANSFER_PLAYER] = new EventNodePeristent("TransferPlayer", [
...
/* */ event_prefab[EventNodeTypes.SET_ENTITY_LOCATION] = new EventNodePeristent("NotYetImplemented", []);
/* */ event_prefab[EventNodeTypes.SCROLL_MAP] = new EventNodePeristent("NotYetImplemented", []);
/* */ event_prefab[EventNodeTypes.SET_MOVEMENT_ROUTE] = new EventNodePeristent("NotYetImplemented", []);
event_prefab[EventNodeTypes.TINT_SCREEN] = new EventNodePeristent("TintScreen", [
...
event_prefab[EventNodeTypes.FLASH_SCREEN] = new EventNodePeristent("WillNotBeImplemented", []);
event_prefab[EventNodeTypes.SHAKE_SCREEN] = new EventNodePeristent("ShakeScreen", [
...
event_prefab[EventNodeTypes.PLAY_BGM] = new EventNodePeristent("PlayBGM", [
    ["BGM", DataTypes.AUDIO_BGM, 0],
    ["Volume", DataTypes.INT, 0, 1, false, 100],
    ["Pitch", DataTypes.INT, 0, 1, false, 100]
]);
event_prefab[EventNodeTypes.FADE_BGM] = new EventNodePeristent("FadeBGM", [
    ["Volume", DataTypes.INT],
    ["Time", DataTypes.FLOAT, 0, 1, false, 1],
    ["Stop On Complete?", DataTypes.BOOL, 0, 1, false, true]
]);
event_prefab[EventNodeTypes.RESUME_BGM] = new EventNodePeristent("ResumeAutomaticBGM", []);
...
event_prefab[EventNodeTypes.PLAY_SE] = new EventNodePeristent("PlaySoundEffect", [
    ["Sound Effect", DataTypes.AUDIO_SE, 0],
    ["Volume", DataTypes.INT, 0, 1, false, 100],
    ["Pitch", DataTypes.INT, 0, 1, false, 100]
]);
event_prefab[EventNodeTypes.STOP_SE] = new EventNodePeristent("StopAllSoundEffects", []);
/* */ event_prefab[EventNodeTypes.RETURN_TO_TITLE] = new EventNodePeristent("NotYetImplemented", []);
event_prefab[EventNodeTypes.CHANGE_MAP_DISPLAY_NAME] = new EventNodePeristent("ChangeMapDisplayName", [
    ["Map", DataTypes.MAP],
    ["New Name", DataTypes.STRING, 0, 1, false, "Whatever the new name is"],
]);
/* */ event_prefab[EventNodeTypes.CHANGE_MAP_TILESET] = new EventNodePeristent("NotYetImplemented", []);
/* */ event_prefab[EventNodeTypes.CHANGE_MAP_BATTLE_SCENE] = new EventNodePeristent("NotYetImplemented", []);
/* */ event_prefab[EventNodeTypes.CHANGE_MAP_PARALLAX] = new EventNodePeristent("NotYetImplemented", []);
event_prefab[EventNodeTypes.SCRIPT] = new EventNodePeristent("Script", [
    ["Code", DataTypes.CODE, 0, 1, true, default_lua_event_script]
]);
/* */ event_prefab[EventNodeTypes.AUDIO_CONTORLS] = new EventNodePeristent("NotYetImplemented", []);
event_prefab[EventNodeTypes.DEACTIVATE_EVENT] = new EventNodePeristent("Deactivate This Event Page", []);
event_prefab[EventNodeTypes.SET_ENTITY_MESH] = new EventNodePeristent("SetEntityMesh", [
    ["Entity", DataTypes.ENTITY],
    ["Mesh", DataTypes.MESH],
]);
event_prefab[EventNodeTypes.SET_ENTITY_SPRITE] = new EventNodePeristent("SetEntitySprite", [
    ["Entity", DataTypes.ENTITY],
    ["Sprite", DataTypes.IMG_OVERWORLD],
]);
event_prefab[EventNodeTypes.SET_MESH_ANIMATION] = new EventNodePeristent("SetEntityMeshAnimation", [
    ["Entity", DataTypes.ENTITY],
...
event_prefab[EventNodeTypes.SCHEDULE_EVENT] = new EventNodePeristent("ScheduleEvent", [
    ["Entity", DataTypes.ENTITY],
