...
missing_autotile = missing[0];
missing_autotile_raw = missing[1];
...
axes_translation = import_d3d("data\\basic\\translation.d3d", false);
axes_translation_x = import_d3d("data\\basic\\translation-x.d3d", false);
axes_translation_y = import_d3d("data\\basic\\translation-y.d3d", false);
axes_translation_z = import_d3d("data\\basic\\translation-z.d3d", false);
axes_translation_x_gold = import_d3d("data\\basic\\translation-x-gold.d3d", false);
axes_translation_y_gold = import_d3d("data\\basic\\translation-y-gold.d3d", false);
axes_translation_z_gold = import_d3d("data\\basic\\translation-z-gold.d3d", false);
skybox_base = import_d3d("data\\basic\\skybox-base.d3d", false);
