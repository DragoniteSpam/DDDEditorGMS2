...
cobject_x_axis.name = "axis x";
cobject_y_axis.name = "axis y";
cobject_z_axis.name = "axis z";
cobject_x_plane.name = "Plane x";
cobject_y_plane.name = "Plane y";
cobject_z_plane.name = "Plane z";
