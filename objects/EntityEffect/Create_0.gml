...
c_object_set_userid(cobject_x, CollisionSpecialValues.TRANSLATE_X);
c_object_set_userid(cobject_y, CollisionSpecialValues.TRANSLATE_Y);
c_object_set_userid(cobject_z, CollisionSpecialValues.TRANSLATE_Z);